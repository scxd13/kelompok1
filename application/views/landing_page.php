               ...
               <div class="row Section">
                  <div class="col">
                     <div class="box">
                        ...
                        <p>Selamat datang di aplikasi Sistem Informasi Penggajian Karyawan <br>PT. JAYA ABADI INDONESIA</p>
                     </div>
                  </div>
         ...
         <div class="Section">
            <div class="text-center">
               ...
               <div class="subHeading">
                  Berikut informasi lebih lengkap tentang website <br>informasi penggajian karyawan PT. JAYA ABADI INDONESIA</div>
            </div>
            ...
            <div class="content">
               <div class="team row">
                  <div class="team-memeber col-md-6 col-lg-4 col-xl-3">
                     <div class="card">
                        <div class="TopImg">
                           <img src="<?php echo base_url(); ?>assets/img/DOLLAR.png" class="rounded-circle w-100 d-block">
                        </div>
                        <div class="TeamInfo text-center">
                           <div class="Name">PENGGAJIAN KARYAWAN</div>
                           <div class="Job">PT. JAYA ABADI INDONESIA</div>
                           <div class="social_links">
                              <div class="social">
                                 <a class="" href="https://github.com/scxd13"><i class="fab fa-github" aria-hidden="true"></i></a>
                              </div>
                              <div class="social">
                                 <a class="" href="https://www.instagram.com/mhmmdrifaii_06/"><i class="fab fa-instagram" aria-hidden="true"></i></a>
                              </div>
                              <div class="social">
                                 <a class="" href="http://www.youtube.com/@muhrifai3474"><i class="fab fa-youtube" aria-hidden="true"></i></a>
                              </div>
                           </div>
                        </div>
                     </div>
         ...
         <div class="container">
            <div class="row">
               <div class="col-12 text-center my-3">
                  Copyright &copy; PT. MEPIM INDONESIA | Penggajian 2024 - All Rights Reserved
               </div>
            </div>
         </div>
      </div>
