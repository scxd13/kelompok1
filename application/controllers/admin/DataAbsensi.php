...
class DataAbsensi extends CI_Controller{
  ...
  public function inputAbsensi(){
    ...
    //   $data['kehadiraan'] = $this->db->query("SELECT * FROM data_kehadiran WHERE id_kehadiran = '$id'")->result();
    ...
    //     $id = $this->insert->post('id_kehadiran');
    //     $this->updateData($id);
    //   }
    //   else{
    //     $id           = $this->input->post('id_kehadrian');
    ...
    //     $this->penggajianModel->update_data('data_kehadrian', $data, $where);
    //     $this->session->set_flashdata('pesan', '<div class="alert alert-success alert-dismissible fade show" role="alert">
